...
NULL);
CREATE TABLE MEASURE(ID BIGINT PRIMARY KEY auto_increment, INSTANT TIMESTAMP WITH TIME ZONE NOT NULL,
VALUE_IN_WATT BIGINT NOT NULL, CAPTOR_ID VARCHAR(255) NOT NULL);
