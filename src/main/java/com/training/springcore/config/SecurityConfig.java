...
public class SecurityConfig {
    ...
    public JdbcUserDetailsManager jdbcUserDetailsManager(DataSource dataSource) {
        ...
        jdbcUserDetailsManager.createUser(User.builder().username("user")
                .password("$2a$10$hiWlfzcr7wHmVMWjRZnYhu1Qv2MzodBi5MyJGVCOSWFioK9Y0RGfW").roles("USER").build());
        jdbcUserDetailsManager.createUser(User.builder().username("admin")
                .password("$2a$10$hiWlfzcr7wHmVMWjRZnYhu1Qv2MzodBi5MyJGVCOSWFioK9Y0RGfW").roles("ADMIN").build());
